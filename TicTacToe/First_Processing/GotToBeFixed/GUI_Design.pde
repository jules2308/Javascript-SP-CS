void GUI_Design() {
  ...
  line(width*1/3, height*1/12, width*2/3, height*1/12);
  line(width*1/3, height*2/12, width*2/3, height*2/12); 
  ...
  //Scoreboard
  rect(width*1/24, height*1/24, width*5/48, height*4/24); //Player 1
  rect(width*9/48, height*1/24, width*5/48, height*4/24); //Player 1 Score
